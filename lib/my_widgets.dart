...
class MyTextFormField extends StatelessWidget {
  ...
  final InputBorder inputBorder;
  String hintText;
  bool obscureText, autocorrect, enableSuggestions;
  final Function(String? value) onSaved;
  final Function(String? value) validator;

  MyTextFormField({required this.keyboardType, required this.inputBorder, required this.onSaved, required this.validator, this.hintText = "", this.obscureText = false, this.autocorrect = true, this.enableSuggestions = true, super.key});
